...
## [0.16.0](https://github.com/JorDunn/saola-theme/compare/saola-theme-v0.15.0...saola-theme-v0.16.0) - 2026-09-07

### Added

- *(saola-theme)* add notification::icon_tile_colored for swatch toasts

## [0.15.0](https://github.com/JorDunn/saola-theme/compare/saola-theme-v0.14.0...saola-theme-v0.15.0) - 2026-09-06

### Added

- add widget::bar_row_container and the notification_centre_card_gap token
- add avatar::placeholder and the sizes.avatar_glyph token
